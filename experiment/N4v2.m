...
VideoName='4-1.mp4';
txtname='N4_0.1.txt';
figure1='N4_0.1_f1.avi';
figure2='N4_0.1_f2.avi';
figure3='N4_0.1_f3.avi';
Ncell=4; % no. of unit cells
Rmin=5;
Rmax=15;
area=[7,38,713-7,679-38]; % x-coord, y-coord, width, height
%% 
%% Program
...
%         radii(deviation==max(deviation))=[];
    ...
    if i==1
        ...
        Ly=90.77; % length of the sample, mm 
        Lx=89.215;
