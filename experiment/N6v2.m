...
VideoName='6-2-1.mp4';
txtname='N6_0.1.txt';
figure1='N6_0.1_f1.avi';
figure2='N6_0.1_f2.avi';
figure3='N6_0.1_f3.avi';
Ncell=6; % no. of unit cells
Rmin=5;
Rmax=10;
area=[1,32,712-1,689-32]; % x-coord, y-coord, width, height
%% 
%% Program
...
%         radii(deviation==max(deviation))=[];
    ...
    if i==1
        ...
        Ly=90.86; % length of the sample, mm 
        Lx=88.9855;
